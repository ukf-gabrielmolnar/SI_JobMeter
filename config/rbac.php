...
return [
    'layout' => 'layouts.main', // You must set it. Example: 'layout' => 'adminlte::page'
    'userModelClass' => App\Models\User::class, // You can change it
    'adminUserId' => 63, // You must set it. This is the initial user id, which must be an administrator, at least at the first stage.
